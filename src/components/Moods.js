...
STEP 1:
  Create a 'mood', 'setMood' pair using the state hook. -------------------------------------------------------------> DONE
...
STEP 2:
  Make the color of the text be crimson if the state of the mood is happy, royalblue otherwise. ---------------------> DONE
...
export default function Moods() {
  ...
  const style = {
    fontSize: '1.5em',
    marginBottom: '0.3em',
    // STEP 2: Make the color of the text be crimson if the state of the mood is happy, royalblue otherwise.
    color: (mood ===  initialMood) ? 'black' : (mood === happyMood) ? 'crimson' : 'royalblue'
  };

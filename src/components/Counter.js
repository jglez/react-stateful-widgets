...
STEP 2:
  The 'style' object has the 'color' property hard-coded to "royalblue". --------------------------------------------> DONE
...
STEP 3:
  We need to replace some hard-coded info in the JSX with expressions, interpolated inside curly brackets. ----------> DONE
...
STEP 4:
  This click handler needs to use 'setCount' to schedule the 'count' to become the current 'count' plus one. --------> DONE
...
STEP 5:
  This click handler needs to use 'setCount' to set the 'count' to be the current 'count' minus one. ----------------> DONE
